		...
		<view class="box">
			...
			<view class="total">
				<view class="titleBox">
					...
					<text class="rightText">及格人数/及格率/及格排名</text>
				</view>
				<view class="total_cont" v-if="lk.num != null">
					<view class="cont_tit">
						<text class="name">联考</text>
						<view class="tit_right">
							<text class="cur">{{lk.num}}</text>
							<text class="dft">/{{lk.per}}</text>
						</view>
					</view>
					<view class="cont_jindu">
						<progress :percent="xn.per * 100" activeColor="#30b6fb" active stroke-width="6"
							border-radius="4" />
					</view>
				</view>

				<view class="total_cont" v-if="xn.num != null">
					<view class="cont_tit">
						<text class="name">本校</text>
						<view class="tit_right">
							<text class="cur">{{xn.num}}</text>
				...
				<block v-for="(item,index) in alllist" :key="index">
					<view class="total_cont">
						...
						<view class="cont_jindu">
							<progress :percent="item.per * 100" activeColor="#30b6fb" active stroke-width="6"
								border-radius="4" />
						</view>
					</view>
				</block>
